...
| ---------------------------------------------------------- | ------- | ---------------------------------------------- |
| Récupérer la liste de tous les projets (projects)          | GET     | `/api/projects/`                               |
| rattachés à l'utilisateur (user) connecté                  |         |                                                |
| ---------------------------------------------------------- | ------- | ---------------------------------------------- |
...
| ---------------------------------------------------------- | ------- | ---------------------------------------------- |
| Récupérer la liste de tous les utilisateurs (users)        | GET     | `/api/projects/{id}/users/`                    |
| attachés à un projet (project)                             |         |                                                |
| ---------------------------------------------------------- | ------- | ---------------------------------------------- |
| Supprimer un utilisateur d'un projet                       | DELETE  | `/api/projects/{id}/users/{id}`                |
| ---------------------------------------------------------- | ------- | ---------------------------------------------- |
| Récupérer la liste des problèmes (issues) liés à un        | GET     | `/api/projects/{id}/issues/`                   |
| projet (project)                                           |         |                                                |
| ---------------------------------------------------------- | ------- | ---------------------------------------------- |
...
| ---------------------------------------------------------- | ------- | ---------------------------------------------- |
| Récupérer la liste de tous les commentaires liés à         | GET     | `/api/projects/{id}/issues/{id}/comments/`     |
| un problème (issue)                                        |         |                                                |
| ---------------------------------------------------------- | ------- | ---------------------------------------------- |
